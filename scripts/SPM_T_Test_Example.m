...
% This is a parametric t-test, and the 'spm1d.stats.ttest2' and 'inference' 
% functions are described comprehensively at spm1d.org (and within the 
% functions as well). This t-test is for the bow-side data and alpha is set
% at 0.05.
